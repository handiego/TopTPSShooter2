...
public class CameraHandler : MonoBehaviour
{
    ...
    void HandlePosition()
    {
        ...
        float temp = delta * cameraConfig.pivotSpeed;
        pivot.localPosition = Vector3.Lerp(pivot.localPosition, newPivotPosition, temp);
        camTrans.localPosition = Vector3.Lerp(camTrans.localPosition, newCameraPosition, temp);
    ...
    void HandleRotation()
    {
        ...
        lookAngle += smoothX * cameraConfig.xRotationSpeed;
        Quaternion targetRot = Quaternion.Euler(0, lookAngle, 0);
        mTransform.rotation = targetRot;

        titlAngle -= smoothY * cameraConfig.yRotationSpeed;
